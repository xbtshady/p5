...
当前是 0.6 的冷灰 + 近黑（0.4 的暖白 + 墨绿已换掉，理由见 DESIGN.md §3.2）：

```css
--bg: #eceef1;          /* 页面底：冷灰 */
--card: #ffffff;
--text: #16181c;        /* 正文（对比度 17.6:1） */
--muted: #6c717b;       /* 次要文字（4.6:1）—— 全站只有这两级文字色 */
--accent: #16181c;      /* 主色：近黑（白字压上去 17.4:1） */
--danger: #d8452f;
--glass: rgba(255, 255, 255, 0.72);   /* 磨砂卡面 */
```
